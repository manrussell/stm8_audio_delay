 ...
 597  009d c65308        	ld	a,21256
 598  00a0 a4cf          	and	a,#207
 599  00a2 c75308        	ld	21256,a
 ...
 710  00cf c65309        	ld	a,21257
 711  00d2 a4fc          	and	a,#252
 712  00d4 c75309        	ld	21257,a
...
1431  01ca ca5301        	or	a,21249
1432  01cd c75301        	ld	21249,a
1434  01d0 2009          	jra	L565
1435  01d2               L365:
1436                     ; 382     TIM2->IER &= (uint8_t)(~TIM2_IT);
1438  01d2 7b01          	ld	a,(OFST+1,sp)
1439  01d4 43            	cpl	a
1440  01d5 c45301        	and	a,21249
1441  01d8 c75301        	ld	21249,a
1442  01db               L565:
1443                     ; 384 }
1446  01db 85            	popw	x
1447  01dc 81            	ret
...
1832  0211 c65305        	ld	a,21253
1833  0214 a48f          	and	a,#143
1834  0216 1a01          	or	a,(OFST+1,sp)
1835  0218 c75305        	ld	21253,a
1836                     ; 515 }
1839  021b 84            	pop	a
1840  021c 81            	ret
...
1888  021e c65306        	ld	a,21254
1889  0221 a48f          	and	a,#143
1890  0223 1a01          	or	a,(OFST+1,sp)
1891  0225 c75306        	ld	21254,a
1892                     ; 534 }
1895  0228 84            	pop	a
1896  0229 81            	ret
...
1944  022b c65307        	ld	a,21255
1945  022e a48f          	and	a,#143
1946  0230 1a01          	or	a,(OFST+1,sp)
1947  0232 c75307        	ld	21255,a
1948                     ; 553 }
1951  0235 84            	pop	a
1952  0236 81            	ret
...
2990  0341 c65305        	ld	a,21253
2991  0344 a4f3          	and	a,#243
2992  0346 1a01          	or	a,(OFST+1,sp)
2993  0348 c75305        	ld	21253,a
2994                     ; 928 }
2997  034b 84            	pop	a
2998  034c 81            	ret
...
3046  034e c65306        	ld	a,21254
3047  0351 a4f3          	and	a,#243
3048  0353 1a01          	or	a,(OFST+1,sp)
3049  0355 c75306        	ld	21254,a
3050                     ; 948 }
3053  0358 84            	pop	a
3054  0359 81            	ret
...
3102  035b c65307        	ld	a,21255
3103  035e a4f3          	and	a,#243
3104  0360 1a01          	or	a,(OFST+1,sp)
3105  0362 c75307        	ld	21255,a
3106                     ; 968 }
3109  0365 84            	pop	a
3110  0366 81            	ret
...
3758  0419 43            	cpl	a
3759  041a c75302        	ld	21250,a
3760                     ; 1110   TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
3762  041d 35ff5303      	mov	21251,#255
3763                     ; 1111 }
3766  0421 81            	ret
...
3998  044c 72115308      	bres	21256,#0
...
4009  045b c65305        	ld	a,21253
4010  045e a40c          	and	a,#12
4011  0460 1a01          	or	a,(OFST+0,sp)
4012  0462 c75305        	ld	21253,a
...
4097  047c 72195308      	bres	21256,#4
...
4108  048b c65306        	ld	a,21254
4109  048e a40c          	and	a,#12
4110  0490 1a01          	or	a,(OFST+0,sp)
4111  0492 c75306        	ld	21254,a
...
4196  04ac 72115309      	bres	21257,#0
...
4207  04bb c65307        	ld	a,21255
4208  04be a40c          	and	a,#12
4209  04c0 1a01          	or	a,(OFST+0,sp)
4210  04c2 c75307        	ld	21255,a
